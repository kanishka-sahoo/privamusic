...
try{
 ...
 await page.route('http://scroll.test/**',async route=>{
  ...
  // Serve the Vite build; run `npm run build` first.
 ...
 await page.evaluate(jobs=>privamusic.render({connected:true,navReady:true,navidromePort:4533,jobs:[{...jobs[0],id:'new-job'},...jobs]}),changed);
